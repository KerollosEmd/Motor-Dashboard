...
#define DIO_u8_PB3_DIRECTION                       DIO_u8_OUTPUT_INIT
...
/* Init Direction for PORTA (For controlling) */
...
/* Init Direction for PORTC (for KeyPad) */
#define DIO_u8_PC0_VALUE                       DIO_u8_INPUT_PULLED_UP
#define DIO_u8_PC1_VALUE                       DIO_u8_INPUT_PULLED_UP
#define DIO_u8_PC2_VALUE                       DIO_u8_INPUT_PULLED_UP
#define DIO_u8_PC3_VALUE                       DIO_u8_INPUT_PULLED_UP
#define DIO_u8_PC4_VALUE                       DIO_u8_OUTPUT_HIGH
#define DIO_u8_PC5_VALUE                       DIO_u8_OUTPUT_HIGH
#define DIO_u8_PC6_VALUE                       DIO_u8_OUTPUT_HIGH
#define DIO_u8_PC7_VALUE                       DIO_u8_OUTPUT_HIGH

/* Init Direction for PORTD (for LCD) */
